...
async function checkweather(city) {
    ...
    document.querySelector(".temperature").innerHTML=Math.round(data.list[17].main.temp)+'°C';
    document.querySelector(".temperature1").innerHTML=Math.round(data.list[17].main.temp)+'°C';

    document.querySelector(".humidity").innerHTML=data.list[17].main.humidity +"%";
    document.querySelector(".wind").innerHTML=Math.round(data.list[17].wind.speed) +"km/h"; 
